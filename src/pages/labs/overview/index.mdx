...
Do you want to learn more about CP4MCM using your ROKS environment? Here is the right place. In the following sections, you will have hands-on experience with Cloud Pak for AI4Cyber. And to complete the labs, you will use your CP4MCM environment on ROKS.
