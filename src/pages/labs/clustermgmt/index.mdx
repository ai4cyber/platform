...
<FeatureCard
  title="Multicluster Management with IBM Cloud Pak for AI4Cyber"
  color="dark"
  >
...
Because of that, you want to explore how IBM Cloud Pak for AI4Cyber, provides consistent visibility, governance and automation of your complex environment.
...
1.To start the lab, you should be in your Cloud Pak for AI4Cyber Web Console. If you are not, check [here](../beforestart/) how to open your console page.
...
26.Add a new label, **environment** (1), and give a value **QA** (2). Click **+** (3) and **save** (4) the changes.
  ...
  Great, your both clusters are ready and managed by IBM Cloud Pak for AI4Cyber. Using this Pak, you are able to manage both cluster from a single pane of glass. Let's check it in the next section.
...
1.With IBM Cloud Pak for AI4Cyber you are able to manage all your cluster from a single control panel. Open the **Menu** button (1) and click **Observe environments** (2) > **Overview** (3).
...
1.Back to the IBM Cloud Pak for AI4Cyber web page tab, click on the **Search** button.
...
4.From this screen you can open Pod definition, edit the values and view logs. You are able to do this for any objects, in any managed cluster.
  ...
  Congratulations! You have successfully completed the lab “Multicluster Management with IBM Cloud Pak for AI4Cyber”.

***

## Summary

You completed the Cloud Pak for AI4Cyber tutorial: Multi-cluster Management. Throughout the tutorial, you explored the key takeaways:
- `Understand Cloud Pak for AI4Cyber`;
- `Add a managed cluster`;
- `Deploy an application chart`;
-	`Manage and monitor application resources of local and remote clusters`;

If you would like to learn more about Cloud Pak for AI4Cyber, please refer to:
-	<a href="https://www.ibm.com/cloud/cloud-pak-for-management" target="blank">Cloud Pak for AI4Cyber home page</a>
- <a href="https://www.ibm.com/demos/collection/Cloud-Pak-for-Multicloud-Management" target="blank">Cloud Pak for AI4Cyber Demos </a>
