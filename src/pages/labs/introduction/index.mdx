...
IBM Cloud Pak for Platform can manage Kubernetes clusters that are deployed on any target infrastructure - either in your own data center or in a public cloud. IBM Cloud Pak for Platform includes IBM Cloud App Management to simplify monitoring your applications across any cloud environment.
...
For more information about IBM Cloud Pak for Platform, visit: [https://www.ibm.com/cloud/cloud-pak-for-management](https://www.ibm.com/cloud/cloud-pak-for-management)
