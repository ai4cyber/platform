...
IBM Cloud Pak for AI4Cyber can manage Kubernetes clusters that are deployed on any target infrastructure - either in your own data center or in a public cloud. IBM Cloud Pak for AI4Cyber includes IBM Cloud App Management to simplify monitoring your applications across any cloud environment.
...
For more information about IBM Cloud Pak for AI4Cyber, visit: [https://www.ibm.com/cloud/cloud-pak-for-management](https://www.ibm.com/cloud/cloud-pak-for-management)
