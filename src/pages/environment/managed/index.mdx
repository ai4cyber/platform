...
To be able to deliver a **WOW** Cloud Pak for AI4Cyber demo, you need to have Managed clusters. We are working to give you extra clusters to manage (ROKS and IKS) when you request a CP4MCM ROKS environment. But now, you have only your CP4MCM Hub cluster.
