...
Now that you have a ROKS cluster, you need to install manually the Cloud Pak for AI4Cyber. Let's do it!

1. Login to [https://cloud.ibm.com/catalog](https://cloud.ibm.com/catalog) if you have not already

2. From the Catalog, select Cloud Pak for AI4Cyber
...
7. Accept license agreement and click **Install** to install Cloud Pak for AI4Cyber. The installation takes about 30 minutes.
...
10. You have successfully completed cluster provisioning, Cloud Pak for AI4Cyber installation. You are ready to proceed to tutorials that use Cloud Pak for AI4Cyber on ROKS, or install other tools if desired.
