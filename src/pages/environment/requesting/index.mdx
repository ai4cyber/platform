...
Cloud Pak for AI4Cyber ROKS cluster can be provisioned from IBMDemos for demo purposes, self-learning or Proof of Concept projects. If you have not already provisioned a cluster, follow these steps.
...
2. On the IBM Demos page, scroll down to see the Featured Collections section. Then open **Cloud Pak for AI4Cyber** collection.

   ![featured collection](images/2-Request-ROKS.png)

3. Now, scroll down to see the Demo Environments section. If necessary, click **Show All**.  On the **Cloud Pak for AI4Cyber ROKS 4.3 Cluster (Express)** Demo Environment, click **Reserve Instance**.
...
6. The reservation details can be viewed by selecting Details.
   ...
   Now you are ready to move to the next step and install Cloud Pak for AI4Cyber!
